...
WELCOME = (
    ...
    "📱 *Live в моменте — /analyze:*\n"
    "Наводишь камеру телефона на человека (или на видео на экране ноута), либо "
    "грузишь видео файлом/ссылкой — и видишь вживую: *речь, эмоции, позу, пульс*. "
    "Можно переключать фронт/тыл камеры и приближать.\n\n"
